...
class BaseDataset(object):
    ...
    def get_imagedata_info(self, data):
        pids, cams = [], []
        #for _, _, pid, camid in data:  ### zdy add _,
...
class BaseImageDataset(BaseDataset):
    ...
    def print_dataset_statistics(self, train, query, gallery):
        num_train_pids, num_train_imgs, num_train_cams = self.get_imagedata_info_train(train) # zdy
        #num_train_pids, num_train_imgs, num_train_cams = self.get_imagedata_info(train) # original
